...
const upsertIntegrationProviderQueryIR: any = {
  name: 'upsertIntegrationProviderQuery',
  params: [
    {
      name: 'service',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 280, b: 286, line: 19, col: 5}]}
    },
    {
      name: 'authStrategy',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 294, b: 305, line: 20, col: 5}]}
    },
    {
      name: 'scope',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 313, b: 317, line: 21, col: 5}]}
    },
    {
      name: 'clientId',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 325, b: 332, line: 22, col: 5}]}
    },
    {
      name: 'clientSecret',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 340, b: 351, line: 23, col: 5}]}
    },
    {
      name: 'consumerKey',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 359, b: 369, line: 24, col: 5}]}
    },
    {
      name: 'consumerSecret',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 377, b: 390, line: 25, col: 5}]}
    },
    {
      name: 'serverBaseUrl',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 398, b: 410, line: 26, col: 5}]}
    },
    {
      name: 'webhookUrl',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 418, b: 427, line: 27, col: 5}]}
    },
    {
      name: 'teamId',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 435, b: 440, line: 28, col: 5}]}
    }
  ],
  usedParamSet: {
    service: true,
 ...
 * ```
 */
export const upsertIntegrationProviderQuery = new PreparedQuery<
  IUpsertIntegrationProviderQueryParams,
  IUpsertIntegrationProviderQueryResult
>(upsertIntegrationProviderQueryIR)
