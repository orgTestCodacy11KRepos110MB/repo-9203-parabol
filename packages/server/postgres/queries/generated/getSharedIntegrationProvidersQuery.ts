...
const getSharedIntegrationProvidersQueryIR: any = {
  name: 'getSharedIntegrationProvidersQuery',
  params: [
    {
      name: 'orgTeamIds',
      codeRefs: {
        defined: {a: 53, b: 62, line: 3, col: 8},
        used: [{a: 157, b: 166, line: 7, col: 19}]
      },
    ...
    },
    {
      name: 'teamIds',
      codeRefs: {
        defined: {a: 81, b: 87, line: 4, col: 8},
        used: [{a: 254, b: 260, line: 10, col: 39}]
      },
      transform: {type: 'array_spread'}
    },
    {
      ...
      codeRefs: {used: [{a: 185, b: 191, line: 8, col: 17}]}
    }
  ],
  usedParamSet: {orgTeamIds: true, service: true, teamIds: true},
  statement: {
    body: 'SELECT * FROM "IntegrationProvider"\nWHERE "teamId" in :orgTeamIds\nAND "service" = :service\nAND "isActive" = TRUE\nAND ("scope" != \'team\' OR "teamId" in :teamIds)',
    loc: {a: 102, b: 261, line: 6, col: 0}
  }
}
 ...
 * ```
 */
export const getSharedIntegrationProvidersQuery = new PreparedQuery<
  IGetSharedIntegrationProvidersQueryParams,
  IGetSharedIntegrationProvidersQueryResult
>(getSharedIntegrationProvidersQueryIR)
