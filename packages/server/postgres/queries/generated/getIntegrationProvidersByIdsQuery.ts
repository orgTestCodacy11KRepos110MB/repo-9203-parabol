...
const getIntegrationProvidersByIdsQueryIR: any = {
  name: 'getIntegrationProvidersByIdsQuery',
  params: [
    {
      name: 'ids',
      codeRefs: {
        defined: {a: 52, b: 54, line: 3, col: 8},
        used: [{a: 118, b: 120, line: 6, col: 13}]
      },
 ...
 * ```
 */
export const getIntegrationProvidersByIdsQuery = new PreparedQuery<
  IGetIntegrationProvidersByIdsQueryParams,
  IGetIntegrationProvidersByIdsQueryResult
>(getIntegrationProvidersByIdsQueryIR)
