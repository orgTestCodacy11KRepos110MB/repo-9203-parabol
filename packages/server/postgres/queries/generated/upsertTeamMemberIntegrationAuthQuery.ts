...
const upsertTeamMemberIntegrationAuthQueryIR: any = {
  name: 'upsertTeamMemberIntegrationAuthQuery',
  params: [
    {
      name: 'auth',
      codeRefs: {
        defined: {a: 55, b: 58, line: 3, col: 8},
        used: [{a: 355, b: 358, line: 17, col: 3}]
      },
      transform: {
        type: 'pick_tuple',
        keys: [
 ...
 * ```
 */
export const upsertTeamMemberIntegrationAuthQuery = new PreparedQuery<
  IUpsertTeamMemberIntegrationAuthQueryParams,
  IUpsertTeamMemberIntegrationAuthQueryResult
>(upsertTeamMemberIntegrationAuthQueryIR)
